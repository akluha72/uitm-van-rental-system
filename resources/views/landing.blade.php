<x-app-layout>
    ...
    <div class="px-4 sm:px-10">
        <div class="mt-32 max-w-7xl mx-auto">
            <div class="mb-16 max-w-2xl text-center mx-auto">
                ...
                <p class="mt-6">Discover the benefits of choosing our van rental service. We provide reliable and
                    customizable solutions to meet your transportation needs.</p>
            </div>
            <div class="grid lg:grid-cols-3 md:grid-cols-2 max-md:max-w-lg mx-auto gap-8">
                <div class="sm:p-6 p-4 flex bg-white rounded-md border shadow-[0_14px_40px_-11px_rgba(93,96,127,0.2)]">
                    ...
                    <div>
                        ...
                        <p>Choose from a variety of van options to suit your travel or delivery requirements. Our fleet
                            includes spacious, fuel-efficient, and multi-purpose vans tailored for you..</p>
                    </div>
                </div>
                <div class="sm:p-6 p-4 flex bg-white rounded-md border">
                    ...
                    <div>
                        ...
                        <p>Travel with peace of mind knowing that all our vans are equipped with top-notch security
                            features, ensuring a safe journey.</p>
                    </div>
                </div>
                <div class="sm:p-6 p-4 flex bg-white rounded-md border">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                    ...
                    <div>
                        ...
                        <p>Enjoy 24/7 customer support for all your inquiries, including roadside assistance, to ensure
                ...
                <div class="sm:p-6 p-4 flex bg-white rounded-md border">
                    ...
                    <div>
                        ...
                        <p>Experience high-performance vans maintained to deliver smooth rides and reliability for long
                            or short-distance trips.</p>
                    </div>
                </div>
                <div class="sm:p-6 p-4 flex bg-white rounded-md border">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                    ...
                    <div>
                        ...
                        <p>Whether you need transportation locally or across regions, our van rental service has you
                            covered, expanding your reach with our extensive network.</p>
                    </div>
                </div>
                <div class="sm:p-6 p-4 flex bg-white rounded-md border">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                    ...
                    <div>
                        ...
                        <p>Stay connected with ease as all our vans are equipped with GPS and other communication tools
                            to ensure seamless coordination during your rental period.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="font-sans p-4 mx-auto lg:max-w-6xl md:max-w-4xl mt-24">
        <h2 class="text-2xl sm:text-3xl font-extrabold text-gray-800 mb-6 sm:mb-10 text-center">Premium Threads</h2>
        ...
        <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4 sm:gap-6">
            <div
                ...
                <div class="p-4 flex-1 flex flex-col">
                    <div class="flex-1">
                        <h5 class="text-sm sm:text-base font-bold text-gray-800 line-clamp-2">Lexicon Luxe</h5>
            ...
            <div
                ...
                <div class="p-4 flex-1 flex flex-col">
                    <div class="flex-1">
                        <h5 class="text-sm sm:text-base font-bold text-gray-800 line-clamp-2">Adjective Attire</h5>
                        <div class="mt-2 flex items-center flex-wrap gap-2">
            ...
            <div
                ...
                <div class="p-4 flex-1 flex flex-col">
                    <div class="flex-1">
                        <h5 class="text-sm sm:text-base font-bold text-gray-800 line-clamp-2">ThreadCraft Vibes</h5>
                        <div class="mt-2 flex items-center flex-wrap gap-2">
                            <h6 class="text-sm sm:text-base font-bold text-gray-800">$14</h6>
                            <div class="bg-gray-100 w-8 h-8 flex items-center justify-center rounded-full cursor-pointer ml-auto"
                                title="Wishlist">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16px"
                                    class="fill-gray-800 inline-block" viewBox="0 0 64 64">
            ...
            <div
                ...
                <div class="p-4 flex-1 flex flex-col">
                    <div class="flex-1">
                        <h5 class="text-sm sm:text-base font-bold text-gray-800 line-clamp-2">Verbal Vogue Tees</h5>
                        <div class="mt-2 flex items-center flex-wrap gap-2">
                            <h6 class="text-sm sm:text-base font-bold text-gray-800">$12</h6>
                            <div class="bg-gray-100 w-8 h-8 flex items-center justify-center rounded-full cursor-pointer ml-auto"
                                title="Wishlist">
            ...
            <div
                ...
                <div class="p-4 flex-1 flex flex-col">
                    <div class="flex-1">
                        <h5 class="text-sm sm:text-base font-bold text-gray-800 line-clamp-2">Jargon Jungle</h5>
                        <div class="mt-2 flex items-center flex-wrap gap-2">
            ...
            <div
                ...
                <div class="p-4 flex-1 flex flex-col">
                    <div class="flex-1">
                        <h5 class="text-sm sm:text-base font-bold text-gray-800 line-clamp-2">Syllable Streetwear</h5>
                        <div class="mt-2 flex items-center flex-wrap gap-2">
                            <h6 class="text-sm sm:text-base font-bold text-gray-800">$14</h6>
                            <div class="bg-gray-100 w-8 h-8 flex items-center justify-center rounded-full cursor-pointer ml-auto"
                                title="Wishlist">
